...
export default function ShareModal({ isOpen, onClose, shareUrl, title, type }: ShareModalProps) {
  ...
  const encodedTitle = encodeURIComponent(title || `Check out my ${type}`);
    ...
    <div className={styles.overlay}>
      <div className={styles.modal} ref={modalRef}>
        <div className={styles.header}>
          <h3 className={styles.title}>Share your {type}</h3>
