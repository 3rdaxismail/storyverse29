...
export default function IOSInstallPrompt() {
  const [showPrompt, setShowPrompt] = useState(() => {
    ...
    // Show prompt only on iOS devices
    return isIOS;
  });

  useEffect(() => {
    // No-op effect, initial state is computed in useState initializer
  }, []);
      ...
      <div className={styles.content}>
        ...
        <div className={styles.text}>
          ...
          <p className={styles.instructions}>
            Tap <span className={styles.shareIcon}>
              <svg width="12" height="16" viewBox="0 0 12 16" fill="none">
                <path d="M6 0L6 10M6 0L2 4M6 0L10 4" stroke="#007AFF" strokeWidth="1.5"/>
                <rect x="0.5" y="11.5" width="11" height="4" rx="0.5" stroke="#007AFF"/>
              </svg>
