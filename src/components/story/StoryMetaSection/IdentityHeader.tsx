/**
 * IdentityHeader - Story name label, share icon, and privacy dropdown
 * Matches StoryHeader (274:149) from Figma - h=20px
 */
...
export default function IdentityHeader({
  ...
  return (
    <div className={styles.identityHeader}>
      <span className={styles.storyNameLabel}>Story name</span>
      ...
      <button 
        className={styles.viewStoryButton}
        onClick={onViewStory}
