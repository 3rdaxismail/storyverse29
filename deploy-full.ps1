# Storyverse Full Deployment Script
# Deploys Firestore rules AND hosting

Write-Host "Storyverse FULL Deployment Pipeline" -ForegroundColor Cyan
...
# Step 5: Deploy to Firebase (FULL)
Write-Host "Step 5/5: Deploying to Firebase (Hosting + Firestore)..." -ForegroundColor Yellow
firebase deploy
if ($LASTEXITCODE -ne 0) {
